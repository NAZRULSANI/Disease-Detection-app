      ...
      <section className="div-1 about">
        ...
        <div>
          <p className="text mt-4">
            Disease Detection System is a healthcare system that tells you whether or not, you
            are at risk of diseases such as various Heart diseases, Liver and
            Kidney diseases. Disease Detection System uses Machine lerning models trained of
        ...
        <Row className="inner-section">
          <Col lg={8} className="align-center">
            <div className="text">
              Here at Disease Detection System we believe the lesser you worry, the healthier
